...
from tasks.views import (tasks_view, add_task_view,del_task_view,complete_task_view, TaskView, UserCreateView, LoginUserView, GenericTaskView, GenericCreateTaskView, GenericUpdateTaskView, GenericDetailTaskView,GenericDeleteTaskView, GenericCompleteTaskView)
